...
export class RectangleStroke extends Rectangle {
    ...
    public clone(): Shape {
        return new RectangleStroke(super.getX(), super.getY(), super.getWidth(), super.getHeight());
    }
    ...
    private _handleMouseUp(e: MouseEvent) {
        ...
        StateHistory.getInstance().pushUndoList(
            new RectangleStroke(super.getX(), super.getY(), super.getWidth(), super.getHeight())
        );
